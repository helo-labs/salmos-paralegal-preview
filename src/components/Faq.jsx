...
export default function Faq() {
  ...
  return (
    <section id="faq" className="border-t border-border bg-bg2 px-5 py-20 sm:px-7 sm:py-24">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="sr lg:sticky lg:top-28">
          ...
          <a
            ...
            className="mx-auto mt-7 flex w-fit items-center gap-2.5 rounded-xl bg-wa px-5 py-3 font-body text-[13.5px] font-semibold text-white transition-transform hover:-translate-y-0.5 hover:bg-waDark lg:mx-0"
          >
